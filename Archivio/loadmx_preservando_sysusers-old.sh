...
echo " "
echo "3) Il db " $NOMEDB " e quello dal quale e' stato fatto il dump "$DUMP_DIR"/"$NOMEDUMP
echo "   abbiano la stessa dimensione e suddivisione dati/log"
echo "4) Il dump, se compresso da sybase nel corso dell'operazione di dump deve avere"
...
echo "  "
echo "4- Nota bene: il punto 4 dei prerequisiti va verificato manualmente!"
echo "  "
